...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/nxtport/apis.md
...
- name: T-mining Secure Container Release API (live) - Create release
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/nxtport/apiv1releases-post-openapi.md
- name: T-mining Secure Container Release API (live) - Release
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/nxtport/apiv1containersidrelease-put-openapi.md
- name: T-mining Secure Container Release API (live) - Create release
  x-api-slug: apiv1releases-post
  description: Serves to create a Container together with its PickupRight that gets
    automatically transferred to the consignee.
