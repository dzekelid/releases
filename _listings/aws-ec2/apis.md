...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/aws-ec2/apis.md
...
- name: AWS EC2 API - Release Address
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/aws-ec2/actionreleaseaddress-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/aws-ec2/actionreleaseaddress-get-openapi.md
- name: AWS EC2 API - Release Address
  x-api-slug: actionreleaseaddress-get
  description: Releases the specified Elastic IP address.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AmazonEC2.png
...
- name: AWS EC2 API - Release Hosts
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/releases/master/_listings/aws-ec2/actionreleasehosts-get-openapi.md
x-common:
- type: x-api-gallery
